...
API_URL="https://api.github.com/repos/Hubdarkweb/tx-themehub/contents/themes"
...
select theme in "${themes[@]}"; do
    if [ -n "$theme" ]; then
        ...
        FILE_URL="https://raw.githubusercontent.com/Hubdarkweb/tx-themehub/main/themes/$theme"
        TEMP_FILE="/tmp/$theme"
